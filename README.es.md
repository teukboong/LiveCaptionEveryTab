...
- **Etiquetado de hablantes (beta)**: etiquetas ①② en los subtítulos para podcasts/entrevistas — embeddings de hablante en CPU + clustering online, el modelo (~109MB) se descarga solo en el primer uso
...
- **Traducción de página en iframes**: los widgets embebidos y cuerpos de iframe también se traducen
