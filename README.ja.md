...
| **CUDA** (`LCC_BACKEND=cuda`) | Windows + NVIDIA（WSL2） | Granite/Qwen3（transformers, `cuda/asr_server.py`）/ Whisper（whisper.cpp q6） | llama.cpp · GGUF（26B/E4B/E2B · 選択 or 自動、OpenAI 互換 HTTP） | [SETUP-windows.md](SETUP-windows.md) |
