...
const UI_TEXT = Object.freeze({
  ko: Object.freeze({
    ...
    pageTranslateHint: "페이지 번역은 오버레이 없이 실제 DOM 텍스트를 순차적으로 교체합니다. 켠 탭에만 적용되고, 탭을 바꿔도 따라가지 않습니다.",
    sectionUi: "UI",
    labelUiLang: "UI 언어",
    ...
    diarize: "화자 구분 (베타 · 첫 사용 시 모델 ~28MB 자동 다운로드)",
    sectionPreset: "프리셋",
  ...
  en: Object.freeze({
    ...
    pageTranslateHint: "Page translation replaces real DOM text incrementally, without an overlay. It applies only to the tab you start it on — switching tabs won't move it.",
    sectionUi: "UI",
    ...
    diarize: "Speaker tagging (beta · auto-downloads ~28MB model on first use)",
